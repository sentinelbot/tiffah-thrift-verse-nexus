...
import { ScanBarcode, ShoppingBag, Check, X } from 'lucide-react';
...
const OrderScanner = () => {
  ...
  const startScanning = async () => {
    ...
    setIsScanning(true);
    toast.info('Scanning for orders...');
    
    // Simulate a scan after a short delay
    setTimeout(() => {
      const barcode = 'TTS-ORDER-' + Math.floor(Math.random() * 1000).toString().padStart(3, '0');
      setLastScan(barcode);
      setIsScanning(false);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Scan order barcodes to process or track orders
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          {isScanning ? (
            ...
            <div className="p-6 border rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-medium">Order Scanned</h3>
